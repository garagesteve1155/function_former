...
Function Former V2 is an  AI-powered Python auto-coder that turns a high-level goal into a working Python script.
It rewrites your goal based on a short interview process, plans an outline of the entire script, generates the code section-by-section, runs pre-flight fixes, executes the program in a sandboxed subprocess, and iteratively repairs issues using your feedback or traceback errors.
